...
Download Coupang from the App Store or Play Store, open it, and tap the
profile icon at the bottom right. In the settings list you'll find a
country/region and language option (언어) — set it to **English**. Most of the
browsing, cart and order screens translate cleanly. Search works in English
too, though Korean search terms still surface more results; typing the Korean
product name (ask us, or use a translation app) often doubles what you find.

### Sign up — what you'll need

The sign-up screens are the one part that stays mostly Korean, and two fields
decide whether the account works:

- **A Korean phone number.** Sign-up requires SMS verification to a Korean
  number. A foreign SIM won't pass this step.
- **Your name exactly as printed on your passport or ARC** (Alien Registration
  Card). A spelling mismatch here is the classic cause of payment and identity
  verification errors weeks later.
