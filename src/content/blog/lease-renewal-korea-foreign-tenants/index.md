---
title: "Lease Renewal in Korea: The Step Foreign Tenants Miss"
...
coverCaption: "The right most tenants never use"
draft: false
---
...
![The Internet Registry Office home page, with a single search box for entering a property address](./iros-property-register-search.webp)
...
![The pyojebu section of a Korean property register, showing address, structure and floor areas, with older entries struck through](./register-pyojebu-property-description.webp)
...
![An eulgu section of a Korean property register reading no recorded matters](./register-eulgu-no-encumbrances.webp)
...
![Timeline showing that a mortgage registered after move-in ranks below the tenant, while a deposit increase at renewal ranks only from its new fixed date](./deposit-priority-by-date.webp)
