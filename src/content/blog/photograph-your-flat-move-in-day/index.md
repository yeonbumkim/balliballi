...
coverCaption: "The number nobody thinks to photograph"
draft: false
---
...
![A Korean gas meter with a reading of 04688.359 cubic metres](./gas-meter.webp)
...
![Close-up of the meter dial showing black digits and red decimal digits](./gas-meter-digits.webp)
...
![A shared kitchen with a fridge, sink and worktop](./kitchen-appliances.webp)
...
![Black mould along the base of a wall behind a lifted strip](./existing-damage.webp)
...
Two things happen either side of those photographs. On the way in, the
flat gets cleaned before your furniture lands, and the walk-through is
where you separate what a cleaner fixes from what the landlord has to
repair — that is
...
settling before you agree to anything, because the standard offer is a
three-year contract.
