...
coverCaption: "The brand name is on the panel. Find it first."
tags: ["door-lock", "keypad-lock", "digital-lock", "apartment", "troubleshooting"]
draft: false
---
...
![The inside panel of a Milre digital door lock, showing the manual turn knob and a Korean instruction sticker on the battery cover](./door-lock-inside-panel-battery-label.webp)
...
![Close-up of the outside panel of a Korean digital door lock with the maker's name MILRE moulded into the plastic](./door-lock-outside-panel-brand-name.webp)
