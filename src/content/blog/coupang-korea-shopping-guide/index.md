...
![Coupang profile screen in Korean with the country and language menu at the bottom](./coupang-language-setting-menu-korean.webp)
...
![Coupang language settings showing the English BETA option selected](./coupang-english-beta-language-option.webp)
...
![Coupang sign-up consent screen with required and optional checkboxes](./coupang-signup-consent-screen.webp)
...
![Coupang sign-up second step asking for a mobile number with a Verify button](./coupang-signup-phone-verification.webp)
