...
coverAlt: "A foreigner using a self-ticketing kiosk under the CGV sign at the newly reopened CGV Yeouido in IFC Mall, Seoul"
coverCaption: "Self-ticketing at CGV Yeouido"
draft: false
---
...
![The entrance of the newly renovated CGV Yeouido inside IFC Mall](./cgv-yeouido-entrance-ifc-mall.webp)
...
![CGV kiosk home screen in Korean with the ENGLISH button at the bottom](./cgv-kiosk-korean-home-screen.webp)

*The ENGLISH button is right there on the Korean screen · ⓒ @BalliBalliSeoul*

![The same CGV kiosk after switching to full English mode](./cgv-kiosk-english-mode.webp)
...
![The CGV kiosk's Change Theater screen listing Seoul branches in English](./cgv-kiosk-change-theater-list-english.webp)
