---
title: "Working Out in Korea: Gyms, Pools and the Han River"
...
coverCaption: "The path runs for dozens of kilometres"
draft: false
---
...
![A runner on a paved park path in Seoul, with a separate red-surfaced bike lane and a road running alongside](./river-park-running-path.webp)
...
![A row of weight machines beside a matted training floor marked out with orange lines at a Seoul gym](./gym-machines-and-training-floor.webp)
...
![A matted gym zone with numbered floor markers, kettlebells, dumbbells and plyo boxes](./gym-rotation-numbered-zone.webp)
