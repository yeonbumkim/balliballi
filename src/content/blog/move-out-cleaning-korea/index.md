...
cover: "./cover.webp"
coverAlt: "A beige wall with a rough white putty patch where a hole was filled in, clearly visible against the surrounding wallpaper"
coverCaption: "A repair that costs more than the damage did"
draft: false
---
...
![A tiled wall in an empty flat with around a dozen small drill holes above the power sockets](./wall-anchor-holes.webp)
...
![The entrance hall of an empty Korean flat with the front door standing open onto the shared landing](./entrance-hall-handover.webp)
...
![A bathtub where the silicone around the drain has been cut out and replaced by hand, leaving a rough grey square](./bathtub-diy-reseal.webp)
...
![The corner of an empty room where a black mould line runs along the join between the wall and the skirting](./baseboard-mould-line.webp)
